...
<body>
    ...
    <main>
        ...
        <section class="hero" role="img" aria-label="Hero banner">
            <div class="container">
                <h1>Summer Collection Version-4 Premium Picks with extended offer</h1>
                ...
                <div>
                    <button class="btn btn-primary" id="shopNow">Himanth <em class="fas fa-arrow-right"></em></button>
                    <button class="btn btn-ghost" id="exploreDeals">Himanth</button>
                </div>
            </div>
        </section>
